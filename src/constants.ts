...
export enum MESSAGE_TYPE {
  ...
  INSTALLED_OR_UPDATED = 'INSTALLED_OR_UPDATED',
  ...
  GET_DELEGATION_READINESS = 'GET_DELEGATION_READINESS',
  GET_DELEGATION_READINESS_RETURN = 'GET_DELEGATION_READINESS_RETURN',

  // Token transfer history
  GET_TOKEN_TXS_RETURN = 'GET_TOKEN_TXS_RETURN',
  GET_MORE_TOKEN_TXS = 'GET_MORE_TOKEN_TXS',

  // Transaction detail (on-demand vin/vout resolution)
  GET_TX_DETAIL = 'GET_TX_DETAIL',
  GET_TX_DETAIL_RETURN = 'GET_TX_DETAIL_RETURN',

  // ElectrumX server management
  GET_ELECTRUMX_STATUS = 'GET_ELECTRUMX_STATUS',
  GET_ELECTRUMX_STATUS_RETURN = 'GET_ELECTRUMX_STATUS_RETURN',
  SWITCH_ELECTRUMX_SERVER = 'SWITCH_ELECTRUMX_SERVER',
  ELECTRUMX_STATUS_CHANGED = 'ELECTRUMX_STATUS_CHANGED',
